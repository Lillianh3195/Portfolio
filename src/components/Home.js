...
const Home = () => {
  return (
    ...
    <div className="home vh-100">
        <img src="/images/profile.png" class="img-thumbnail rounded-circle" alt="profile image" />
        <h1>Lillian Hoang</h1>
        ...
        <div className="home-link-item">
            <Link to="/projects" style={{ textDecoration: 'none' }}>View My Projects</Link>
        </div>
        <div className="home-link-item">  
            <Link to="/contacts" style={{ textDecoration: 'none' }}>Contact Me</Link>
        </div>     
        </div>  
    </div>
