...
const App = () => {
  ...
  let imageSrcs = [
    ...
    ["/images/logic_grid_puzzle/0.png", "/images/logic_grid_puzzle/1.png"],
  ];
  ...
  let projects = [
    ...
    },
    {
      ...
      description:
        "This project implements a full joint distribution, a Bayesian network containing boolean-variable nodes, and likelihood-weighting to answer queries.",
